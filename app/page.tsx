  ...
  return (
    <>
      ...
      <div className="flex relative mt-10 w-full h-[80vh] justify-center" id="hero">
        <div className="mx-4 lg:mx-20 z-10 flex flex-col md:flex-row items-center justify-center gap-10">
          ...
          <div className="flex gap-2 items-center w-full md:w-[40vw] overflow-hidden h-10 relative">
